...
<div class="header">
    ...
    <div class="col-auto">
    	<div class="log white cut_line"><?php echo L('hello'),"<font color='red'>".$admin_username."</font>"?>  [<?php echo $rolename?>]<span>|</span><a href="?m=admin&c=index&a=public_logout">[<?php echo L('exit')?>]</a><span>|</span>
