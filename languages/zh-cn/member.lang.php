...
$LANG['inave'] = '享众网';
$LANG['phpcmsV9'] = '享众网';
$LANG['improve_the_info'] = '完善信息';
$LANG['login_for_improve_the_info'] = '授权成功！完善一下信息开始浏览。';
$LANG['promptly'] = '提示:';
$LANG['email'] = '邮箱';
$LANG['or'] = '或者';
$LANG['nickname'] = '昵称';
...
$LANG['no_phpcms_account'] = '您还没有注册享众网会员？';
$LANG['immediately'] = '立即';
$LANG['use_passport'] = '使用外部通行证';
$LANG['other_passport'] = '其他通行证';
$LANG['other_passport_introduce'] = '通行证介绍';
$LANG['other_passport_info'] = '享众网支持使用第三方账号登录。';
$LANG['user_sina_login'] = '用新浪微博登录';
$LANG['user_qq_login'] = '用腾讯QQ登录';
$LANG['user_sadn_login'] = '盛大通行证';
$LANG['user_qqweibo_login'] = '用腾讯微博登录';
$LANG['input'] = '请输入';
$LANG['checkcode'] = '验证码';
$LANG['validate'] = '验证';
$LANG['user'] = '会员';
...
$LANG['infomation_is_incomplete'] = '你输入的信息不完整，无法完成登录';
$LANG['illegal_operation'] = '非法操作，请重新登录';
...
$LANG['authorize_failure'] = '授权失败';
$LANG['authorize_getweibouserid_faliure'] = '从新浪授权接口获取用户ID失败';
...
$LANG['sina_login_notice'] = '使用新浪微博连接登录享众网,将精彩内容分享到新浪微博。';
$LANG['qq_login_notice'] = '使用腾讯微博连接登录享众网,将精彩内容分享到腾讯微博。';
$LANG['snda_login_notice'] = '使用用盛大连接登录享众网,轻松使用盛大所有服务。';
