...
<div id="header">
	<div class="content">
	<div class=""><a href="<?php echo $siteinfo['domain'];?>"><img src="<?php echo IMG_PATH;?>logo.png" height="60"/></a></div>
...
<input type="hidden" name="forward" id="forward" value="<?php echo $forward;?>">
		...
		<div class="submit"><input type="submit" name="dosubmit" id="dosubmit" value="<?php echo L('login');?>"></div>
		<div class="submit"><input type="button" name="register" id="dosubmit" value="<?php echo L('register');?>" onclick="redirect('<?php echo APP_PATH;?>index.php?m=member&c=index&a=register&siteid=<?php echo $siteid;?>')"></div>
		</div>
</form>
</div>
    <div class="col-auto">
            	...
            	<div class="content">
                    ...
                    <div class="pass-logo">
                        ...
                        <?php if($setting['snda_akey'] || $setting['snda_skey']) { ?>
                        	<li style="margin-right:14px;"><a href="javascript:;" onclick="show_login('snda');return false;" style="background-image:url(<?php echo IMG_PATH;?>member/logo/snda_16_16.png)"><?php echo L('user_sadn_login');?></a></li>
                        <?php } ?>
                        <?php if($setting['sina_akey'] || $setting['sina_skey']) { ?>
                            <li><a href="javascript:;" onclick="show_login('sina');return false;" style="background-image:url(<?php echo IMG_PATH;?>member/logo/sina_16_16.png)"><?php echo L('user_sina_login');?></a></li>
                        <?php } ?>

						<?php if($setting['qq_akey'] || $setting['qq_skey']) { ?>
                        	<li style="margin-right:14px;">&nbsp;<a href="javascript:;" onclick="show_login('qq');return false;" style="background-image:url(<?php echo IMG_PATH;?>member/logo/qq_16_16.png)"><?php echo L('user_qqweibo_login');?></a></li>
						<?php } ?>
						<?php if($setting['qq_appkey'] || $setting['qq_appid']) { ?>
                        	<li style="margin-right:14px;"><a href="<?php echo APP_PATH;?>index.php?m=member&c=index&a=public_qq_loginnew" target="_blank" style="background-image:url(<?php echo IMG_PATH;?>member/logo/qq_16_16.png)"><?php echo L('user_qq_login');?></a></li>
						<?php } ?>
                        </ul>
                        <p>
